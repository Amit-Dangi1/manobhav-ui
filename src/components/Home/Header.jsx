            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item d-flex align-items-center mt-2 mt-lg-0 me-5">
                      {!isUserExit()?<><button className="btn btn-signup-custom btn1 rounded-5 me-5" type="button"><Link className='text-dark   text-decoration-none fw-medium' to="/signup">Sign Up</Link></button><button className="btn btn-login-custom btn1 rounded-5  me-5" type="button"><Link className='text-dark text-decoration-none fw-medium' to="/login">Login</Link></button></> 
                                    :<button onClick={logout} className="btn btn-login-custom btn1 fw-medium rounded-5  me-5" type="button">SignOut</button>
}  
                    </li>
                </ul>
            </div>
