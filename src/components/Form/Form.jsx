        ...
        <div className='row'>
            ...
            <div className='col-lg-6 col-md-6 col-sm-12 mt-5 pt-3'>
               ...
               <form action="" onSubmit={handelClick}>
                ...
                <span className=''>Sleep Hours :</span><input onChange={(event)=>{if(event.target.value === "" ||(event.target.value>=1 && event.target.value<=10)){setform({...form,sleepHours:event.target.value})}}} className='inputborder mx-5 shadow-sm w-25' type="number" name="sleepHours" id="" min="1" max="10" placeholder='Enter'required/><br /><br />
                <span className=''>Stress Level :</span><input onChange={(event)=>{if(event.target.value === "" ||(event.target.value>=1 && event.target.value<=10)){setform({...form,stressLevel:event.target.value})}}} className='inputborder mx-5 shadow-sm w-25' type="number" name="stressLevel" id="" min="1" max="10" placeholder='1 to 10' required/><br /><br />
                <span className=''>PeerInfluence : </span><input onChange={(event)=>{if(event.target.value === "" ||(event.target.value>=1 && event.target.value<=10)){setform({...form,peerInfluence:event.target.value})}}} className='inputborder mx-4 shadow-sm w-25' type="number" name="peerInfluence" id="" min="1" max="10" placeholder='1 to 10' required/><br /><br/>
